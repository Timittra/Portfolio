                    ...
                    <div className="col-md-6 col-lg-6 col-sm-12 col-xs-12 mt-5">
                        <div className="skills p-3">
                            ...
                            React Bootstrap, Node (crud operation), WordPress theme customization.</li>
                                ...
                                <li><strong>Special Qualification:</strong> Good presentation quality.</li>
                            </ul>
                        </div>
                        ...
                        <div className="resume-projects p-3">
                            <h3>Projects</h3>
                            <ul>
                                <li><strong><h4>Museum’s Galaxy</h4></strong>
                            ...
                            <ul>
                                <li><strong><h4>Laptop Magic HUB</h4></strong>
                            ...
                            <ul>
                                <li><strong><h4>Ticket to Train</h4></strong>
                            ...
                            <ul>
                                <li><strong><h4>City Museum Management</h4></strong>
                    ...
                    <div className="col-md-6 col-lg-6 col-sm-12 col-xs-12 mt-5">
                        <div className="extra-curricular p-3">
                            ...
                            <ul>
                                ...
                                <li>MindSpeark’18 at Ahsanullah University of Science and Technology.</li>
                            </ul>
                        </div>
                        <div className="education p-3">
                            <h3>Education</h3>
                            <ul>
                                <li><strong><h4>Dhaka University, Bangladesh:</h4></strong>MBA in Management Information Systems.</li>
                                <li><strong><h4>Ahsanullah University of Science and Technology Dhaka, Bangladesh:</h4></strong>
                                                B.Sc. in Computer Science and Engineering, June 2015–June 2019</li>
                            </ul>
                        </div>
